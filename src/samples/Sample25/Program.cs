...
namespace Sample25
{
    ...
    internal static class Program
    {
        private static async Task Main()
        {
            ...
            inputs.Add("gloVar1", new Variable("全局参数1"));
            inputs.Add("gloVar2", new Variable("全局参数2"));

            var workflowExecutionContext = await invoker.StartAsync<DataProcessingWorkflow>(inputs);
            ...
            inputs.Add( "Sensor1", new Variable(sensor1Value));
            ...
            await invoker.ResumeAsync<DataProcessingWorkflow>(workflowInstance1, inputs);
            ...
            inputs.Add("Sensor2", new Variable(sensor2Value));
            ...
            await invoker.ResumeAsync(workflowInstance2, inputs);
